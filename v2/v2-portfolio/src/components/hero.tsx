  ...
  return (
    <div className="relative h-screen">
      ...
      <div className="-z-999 h-[50rem] w-full dark:bg-transparent bg-transparent dark:bg-grid-white/[0.1] bg-grid-black/[0.1] relative flex items-center justify-center flex-col px-4">
        {/* Radial gradient for the container to give
         a faded look */}
        ...
        <h1 className="bg-clip-text text-transparent text-center bg-gradient-to-b from-neutral-900 to-neutral-700 dark:from-neutral-600 dark:to-white text-5xl md:text-6xl lg:text-7xl font-sans py-1 md:py-3 relative z-20 font-bold tracking-tight">
